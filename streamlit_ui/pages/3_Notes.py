...
#         else:
#             res = requests.post(f"http://127.0.0.1:5000/user/notes/", json={
#                 # "user_id": user_id,
#                 "title": title,
...
#         #     st.error("Invalid User!")
#         # else:
#             res = requests.get(f"http://127.0.0.1:5000/user/notes/", headers=headers)
#             print(res)
#             if res.status_code == 200:
#                st.json(res.json())
#             else:
...
#         else:
#             res = requests.put(f"http://127.0.0.1:5000/user/notes/{note_id}", json={
#                 "note_id":note_id,
#                 "title":title,
#                 "description":description
#             }, headers=headers)
...
#             st.error("Invalid Note!")
#         else:
#             res = requests.delete(f"http://127.0.0.1:5000/user/notes/{note_id}",headers=headers)
#             print(res)
#             if res.status_code == 200:
